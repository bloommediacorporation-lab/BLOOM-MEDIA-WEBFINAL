<script>
  ...
  import MarketingImpact from './MarketingImpact.svelte';
  import ServicesShowcase from './ServicesShowcase.svelte';
...
<div class="relative z-10 bg-[#050505] shadow-[0_20px_50px_rgba(0,0,0,0.5)] min-h-screen">
  <Hero />
  <MarketingImpact />
  <ServicesShowcase />
  <ProcessTimeline />
