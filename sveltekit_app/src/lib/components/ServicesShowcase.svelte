...
<section class="relative w-full h-[100svh] bg-[#000100] overflow-hidden flex flex-col justify-center touch-pan-y">
            ...
            <div class="relative w-full grid grid-cols-1 grid-rows-1 items-end overflow-hidden pointer-events-none z-10">
                {#key currentIndex}
                    <div 
                        ...
                        onintrostart={(e) => applyWillChange(e.currentTarget)}
                        onintroend={(e) => clearWillChange(e.currentTarget)}
                        onoutrostart={(e) => applyWillChange(e.currentTarget)}
                        onoutroend={(e) => clearWillChange(e.currentTarget)}
                    >
